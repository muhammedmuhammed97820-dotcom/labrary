...
export class CommunityComponent implements OnInit {
  ...
  bookId = ''; quotes: Quote[] = []; comments: CommunityComment[] = []; quoteText = ''; quotePage: number | null = null; commentText = ''; replyTo = ''; loading = true; saving = false; liking = new Set<string>();
