...
export interface Quote { _id: string; book: CommunityBook | string; text: string; likesCount: number; liked: boolean; reportCount: number; status: string; user: CommunityUser; createdAt: string; }
...
export class CommunityService {
  ...
  addQuote(book: string, text: string): Observable<Quote> { return this.http.post<Quote>(`${this.api}/quotes`, { book, text }); }
